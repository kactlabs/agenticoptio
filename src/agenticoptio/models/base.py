"""
Base classes for AgenticOptio models.

Provides abstract base classes for chat and embedding model implementations.
"""
...
from agenticoptio.core.messages import AIMessage
...
def convert_messages(messages: list[Any]) -> list[dict[str, Any]]:
    ...
    This utility ensures compatibility with various message formats.
